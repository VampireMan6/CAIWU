<template>
	<view class="w-100 containers column">
		...
		<view class="container b-b">
			...
			<img class="return-img m-b-30" src="../../static/tab-2/return-b.png" alt="" @click="back">
			<view class="w-100 m-b-60">
				<text class="f-30 c-333 f-w-600">忘记密码</text>
				<view class="relative">
			...
			<view v-else class="w-100 button1 f-center j-center">
